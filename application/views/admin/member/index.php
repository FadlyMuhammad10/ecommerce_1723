                                    ...
                                    foreach ($member as $item) : $no++ ?>
                                        <tr>
                                            ...
                                            <?php if ($item->statusAktif == "Y") { ?>
                                                ...
                                                <td>
                                                    <form action="<?= site_url('member/update/' . $item->idKonsumen);  ?>" method="post">
                                                        <input type="hidden" name="statusAktif" value="N">
                                            ...
                                            <?php } else if ($item->statusAktif == "N") {   ?>
                                                ...
                                                <td>
                                                    <form action="<?= site_url('member/update/' . $item->idKonsumen);  ?>" method="post">
                                                        <input type="hidden" name="statusAktif" value="Y">
                                            ...
                                            <?php } ?>
                                            <td>
                                                <a href="<?= site_url('member/edit/' . $item->idKonsumen);  ?>" class="btn btn-warning">Edit</a>
                                                <a href="<?= site_url('member/delete/' . $item->idKonsumen);  ?>" class="btn btn-danger">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </table>
